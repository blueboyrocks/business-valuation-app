...
const REQUIRED_SECTIONS: RequiredSection[] = [
  ...
  {
    // Valuation reconciliation/synthesis serves as conclusion of value
    matchPatterns: ['conclusion of value', 'conclusionofvalue', 'conclusion', 'valuation reconciliation', 'valuationreconciliation', 'valuation synthesis'],
  ...
  {
    matchPatterns: ['asset approach', 'assetapproach', 'asset-based', 'assetapproachanalysis'],
    displayName: 'Asset Approach',
    minimumWords: 100,
  },
  {
    matchPatterns: ['income approach', 'incomeapproach', 'income-based', 'incomeapproachanalysis'],
    displayName: 'Income Approach',
    minimumWords: 150,
  },
  {
    matchPatterns: ['market approach', 'marketapproach', 'market-based', 'marketapproachanalysis'],
  ...
  // Note: Sources and References removed from required sections as it's not generated by narrative passes
  // The professional PDF template includes standard sources automatically
];
